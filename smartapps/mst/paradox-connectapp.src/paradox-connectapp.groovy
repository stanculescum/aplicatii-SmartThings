...
definition (
    name: "Paradox ConnectApp",
    namespace: "mST",
    author: "Mihail Stanculescu",
    description: "Paradox Alarm Integration App",
    category: "My Apps",
    iconUrl: "https://raw.githubusercontent.com/stanculescum/aplicatii-smarthome/master/pictures/paradox-icon.png",
    iconX2Url: "https://raw.githubusercontent.com/stanculescum/aplicatii-smarthome/master/pictures/paradox-icon.png",
    iconX3Url: "https://raw.githubusercontent.com/stanculescum/aplicatii-smarthome/master/pictures/paradox-icon.png",
    oauth: true
)
    ...
    {    	
     	selected.each { dni ->
            ...
            if (!d)
            {
                ...
                d = addChildDevice("mST",deviceType, dni, newDevice?.value.hub, [name: newDevice?.value.name])
