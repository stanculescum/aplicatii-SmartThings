/**
 *  Meteo furnizat de The Weather Company Smartapp
 *
 *  Copyright 2019
 *
...
def addDevices() {
	...
	def twcstate = mymap['location']['country']
	log.debug twccity
	subscribe(addChildDevice("mST", "Meteo device", state.deviceId, null, [
		"label": "Vremea în ${twccity}, ${twcstate}",
		"data": [
