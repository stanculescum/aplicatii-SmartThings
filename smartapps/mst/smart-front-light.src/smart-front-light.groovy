...
def mainSettingsPage() {
	...
	name: 		"mainSettingsPage", 
		...
		section("Control these switches/bulbs") {
			input (
				name:		"switches", 
				type:		"capability.switchLevel", 
				title: 		"Switches/Bulbs?", 
				required: 	true, 
				multiple: 	true
			)
		...
		input (
				name:		"color", 
				type:		"enum", 
				title: 		"Color for bulbs?",
                options: 	['Cold White','Warm White','Red','Orange','Yellow','Green','Blue','Purple','Pink'],
				defaultValue: 	"Cold White"
			)
		}
