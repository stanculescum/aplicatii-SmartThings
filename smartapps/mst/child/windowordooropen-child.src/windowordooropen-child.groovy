...
definition(
	...
	category: "My Apps",
    parent: "mST/parent:WindowOrDoorOpen!",
...
preferences {
	section("Notify me when the following door(s) or window contact(s) are left open (maximum 30 contacts)...") {
        input "theSensor", "capability.contactSensor", title: "My choise is", multiple:true, required: true, image: "https://raw.githubusercontent.com/stanculescum/aplicatii-smarthome/master/pictures/open-door-window.png"
	}
	section("Notifications") {
		input "sendPushMessage", "enum", title: "Send a push notification?", metadata: [values: ["Yes", "No"]], required: false, image: "https://raw.githubusercontent.com/stanculescum/aplicatii-smarthome/master/pictures/push-notification.png"
		//input "phone", "phone", title: "Send a Text Message to...", required: false, description: ""
	...
	section("Use Speech capability to warn the residents") {
		input "theVoice", "capability.speechSynthesis", required: false, multiple: true, description: "Optional", image: "https://raw.githubusercontent.com/stanculescum/aplicatii-smarthome/master/pictures/voice-icon.png"
		input "powerSwitch", "capability.switch", title: "On/off switch for Voice notifications?", required: false, description: "Optional"
	}
	section("And, when contact is left open for more than this delay in minutes") {
		input "maxOpenTime", "number", title: "Minutes?", required:false, description: "default=5 min."
	}
	section("Turn off the thermostat(s) after the delay; revert this action when closed") {
		input "tstats", "capability.thermostat", multiple: true, required: false, image: "https://raw.githubusercontent.com/stanculescum/aplicatii-smarthome/master/pictures/warmup-4ie.png"
	}
	section("What do I use as the Master on/off switch to enable/disable other smartapps' processing? [ex.for zoned heating/cooling solutions]") {
