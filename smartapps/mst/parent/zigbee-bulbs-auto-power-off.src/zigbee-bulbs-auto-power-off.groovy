/**
 *  ZigBee Bulbs Auto Power Off! - Parent SmartApp for SmartThings
 *
 *  Copyright 2019
 *
 ...
 */
definition(
    name: "ZigBee Bulbs Auto Power Off!",
...
preferences {
    ...
    page(name: "mainPage", title: "Content", install: true, uninstall: true, submitOnChange: true) {
        section {
            app(name: "Auto Power Off!", appName: "ZigBee Bulbs Auto Power Off!-child", namespace: "mST/child", title: "Create a new automation", multiple: true, image: "https://raw.githubusercontent.com/stanculescum/aplicatii-smarthome/master/pictures/start-button.png")
		}
        section("About") { 
			headerSECTION()
		}
