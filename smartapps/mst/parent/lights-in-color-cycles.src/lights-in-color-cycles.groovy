/**
 *  Lights in color cycles - Parent SmartApp for SmartThings
 *
 *  Copyright 2020
 *
...
definition(
    name: "Lights in color cycles",
    namespace: "mST/parent",
    author: "Mihail Stanculescu",
    description: "This application creates lights in color cycles",
    category: "My Apps",
    ...
    iconX3Url: "https://raw.githubusercontent.com/stanculescum/aplicatii-smarthome/master/pictures/color-icon@3x.png"
)
...
def headerSECTION() {
	return paragraph (image: "https://raw.githubusercontent.com/stanculescum/aplicatii-smarthome/master/pictures/color-icon.png", "${textVersion()}")
}

private def textVersion() {
    def text = "This application creates lights in color cycles.\nThe color cycles is in response to an event\nVersion: v1.0 / 2020-06-15"
}